...
public class Employee_Deductions extends javax.swing.JFrame {
  ...
  PreparedStatement pst=null;
    /**
     * Creates new form Employee_Deductions
     */
    ...
    {
        JOptionPane.showMessageDialog( null, "Error connecting to database"+ex,"Deductions Form",JOptionPane.ERROR_MESSAGE);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Employee Salary Deductions");
        setForeground(new java.awt.Color(255, 255, 153));

        txt_id.setEditable(false);

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Search", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Adobe Garamond Pro Bold", 2, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(txt_empid, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        r_amount2.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        jLabel3.setFont(new java.awt.Font("Adobe Garamond Pro Bold", 2, 14)); // NOI18N
        jLabel3.setText("Employee Salary Deductions");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(44, 44, 44)
                                .addComponent(btn_Save, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnCal, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        ...
        if(p==0){
            ...
            try {
                String sql ="insert into Deductions (Id,FirstName,surname,Salary,deduction_amount,"
                        + "deduction_reason,Madeby,EmployeeId) values (?,?,?,?,?,?,'"+value3+"',?)";
                pst=con.prepareStatement(sql);
                pst.setString(1,txt_id.getText());
                pst.setString(2,txt_firstname.getText());
                pst.setString(3,txt_surname.getText());
                pst.setString(4,lbl_sal.getText());
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
          try{
            String sql ="select EmployeeId,FirstnName,surname,Dob,Department,Designation,"
                    + "Status,Date_hired,job_title,Salary from Staff_Information where EmployeeId=? ";
            pst=con.prepareStatement(sql);
